...
<head>
    ...
    <style>
        ...
        /* Style for the iframe to take up the entire viewport */
        #carrot2Frame {
            ...
            z-index: 1000; /* Make sure the iframe is above other content */
        }
    </style>
</head>
<body>
    <!-- Link to retrieve more PubMed articles -->
    <a href="#" id="carrot2Link">Retrieve more PubMed articles here</a>
    
    <!-- Embedding the Carrot2 Workbench in an iframe -->
    <iframe id="carrot2Frame" src="about:blank"></iframe>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (carrot2Link && carrot2Frame) {
                carrot2Link.addEventListener('click', function(event) {
                    ...
                    // Show the iframe with the Carrot2 Workbench
                    carrot2Frame.style.display = 'block';
                    // Set the source of the iframe to Carrot2 Workbench URL
                    carrot2Frame.src = 'https://search.carrot2.org/#/workbench';
                });
            }
        });
    </script>
